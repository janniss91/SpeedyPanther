...
def sample_sinewave(frequency: int, start_time: float = 0.0, end_time: float = 1.0, amplitude: float = 1.0, sample_rate: int = 44_100) -> Tuple[np.ndarray, np.ndarray]:
    """
...
def sample_complex_wave(frequencies: List[int], coeffs: List[float], start_time: float = 0.0, end_time: float  = 1.0, sample_rate: int = 44_100) -> Tuple[np.ndarray, np.ndarray]:
    """
    ...
    for frequency, coeff in zip(frequencies, coeffs):
        timesteps, samples = sample_sinewave(frequency, start_time=start_time, end_time=end_time, sample_rate=sample_rate)
...
def generate_impulse_train(sample_rate: int = 44_100, start_time: float = 0.0, end_time: float  = 1.0, amplitude: float = 1.0) -> Tuple[np.ndarray, np.ndarray]:
...
def generate_noise(sample_rate: int = 44_100, start_time: float = 0.0, end_time: float  = 1.0, amplitude_std: float = 1.0) -> Tuple[np.ndarray, np.ndarray]:
    period = 1 / sample_rate
    timesteps = np.arange(start_time, end_time, period)
